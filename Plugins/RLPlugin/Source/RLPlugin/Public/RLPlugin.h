...
public:
    ...
    static void BlockOnTextureAsyncBuilds( const TArray<FString>& kTextureObjectPaths );
    static void BlockOnTextureAsyncBuild( UTexture* pTexture );
    FString GetSavePath();
...
private:
    ...
    UObject* CreatePhysicsAsset( USkeletalMesh* pMesh, bool bSaveImmediately = false );
